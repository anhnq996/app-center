...
body{min-height:100vh;min-height:100dvh;background:${pageBackground};color:${strong}}
...
@media(max-width:480px){html,body{height:100%;overflow:hidden}body{height:100vh;height:100dvh}main{height:100vh;height:100dvh;min-height:0;padding:8px 10px}.card{max-height:calc(100dvh - 16px);overflow:hidden;padding:16px;border-radius:min(${radii[appearance.cardRadius]}px,22px)}.company{margin-bottom:12px}.company-logo{max-height:24px}.company-name{font-size:10px}.project-logo{width:min(${project.projectLogoWidth ?? 132}px,42vw);height:min(${project.projectLogoHeight ?? 76}px,18vh);margin-bottom:12px}.fallback-logo{border-radius:18px;font-size:22px}.project h1{font-size:22px;line-height:1.08}.project p{margin-top:4px;font-size:12px}.buttons{gap:8px;margin-top:16px}.download-button{min-height:56px;gap:10px;padding:9px 12px;border-radius:14px}.platform-icon{width:38px;height:38px;border-radius:${showIconBackground ? "13px" : "0"}}.platform-icon img{width:22px;height:22px}.generic-icon{font-size:20px}.button-label,.button-version,.button-subtitle{font-size:10px}.button-copy strong{font-size:14px}.security{margin-top:14px;font-size:10px}.recommended{display:none}.download-icon{width:15px;height:15px}}@media(max-width:380px),(max-height:700px){.card{padding:14px}.company{margin-bottom:10px}.project-logo{height:min(${project.projectLogoHeight ?? 68}px,15vh);margin-bottom:10px}.project h1{font-size:20px}.buttons{gap:7px;margin-top:14px}.download-button{min-height:52px;padding:8px 10px}.platform-icon{width:34px;height:34px}.security{margin-top:10px}}
`.trim();
